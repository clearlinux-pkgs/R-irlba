...
Version  : 2.3.4
Release  : 38
URL      : https://cran.r-project.org/src/contrib/irlba_2.3.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/irlba_2.3.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638546031
